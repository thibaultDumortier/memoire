\newglossaryentry{Bitexte}{
    ...
    description={
        ...
        deux textes phrase par phrase(\href{https://en.wikipedia.org/wiki/Parallel_text\#Bitext}{Wikipedia/Parallel\_text\#Bitext})
    }
}
...
\newglossaryentry{BLEU}{
    ...
    description={
        ...
        traduction automatique très similaire (\href{https://cloud.google.com/translate/automl/docs/evaluate?hl=fr}{Évaluer des modèles (Google)})
    }
}
...
\newglossaryentry{CAHAI}{
    ...
    description={
        ...
        Comité sur l'IA (CAI) (\href{https://www.coe.int/fr/web/artificial-intelligence/cahai-1}{site du conseil de l'europe (COE) sur le CAHAI})
    }
}
...
\newglossaryentry{Plongement de phrases}{
    ...
    description={
        ...
        (\href{https://en.wikipedia.org/wiki/Sentence_embedding}{Wikipedia/Sentence\_embedding})
    }
}
