\newglossaryentry{Bitexte}{
    ...
    description={
        ...
        deux textes phrase par phrase(\hyperlink{https://en.wikipedia.org/wiki/Parallel_text\#Bitext}{Wikipedia/Parallel\_text\#Bitext})
    }
}
...
\newglossaryentry{BLEU}{
    ...
    description={
        ...
        traduction automatique très similaire (\hyperlink{https://cloud.google.com/translate/automl/docs/evaluate?hl=fr}{Évaluer des modèles (Google)})
    }
}
...
\newglossaryentry{CAHAI}{
    ...
    description={
        ...
        de droits de l'Homme, de démocratie et d'Etat de droit. Il a depuis été remplacé par le
        Comité sur l'IA (CAI) (\hyperlink{https://www.coe.int/fr/web/artificial-intelligence/cahai-1}{site du conseil de l'europe (COE) sur le CAHAI})
    }
}
...
\newglossaryentry{CLIR}{
    ...
    description={
        ...
        l'état de l'art (\hyperlink{https://en.wikipedia.org/wiki/Cross-language_information_retrieval}{Wikipedia/Cross-language\_information\_retrieval})
    }
}
...
\newglossaryentry{Fonction softmax}{
    name=Softmax,
    description={
        La fonction softmax est une généralisation de la fonction sigmoïde au cas multi-classes.
...
\newglossaryentry{Similarité cosinus}{
    ...
    description={
        ...
        de similarité (\hyperlink{https://fr.wikipedia.org/wiki/Similarité_cosinus}{Wikipedia/Similarité\_cosinus})
    }
}
...
\newglossaryentry{Similarité sémantique}{
    ...
    description={
        ...
        instances) (\hyperlink{https://fr.wikipedia.org/wiki/Similarité_sémantique}{Wikipedia/Similarité\_sémantique})
    }
}
...
\newglossaryentry{Courbe AUC ROC}{
    name=Courbe AUC ROC,
    description={
        ...
        (\hyperlink{https://developers.google.com/machine-learning/crash-course/classification/roc-and-auc?hl=fr}{Google for developers})
    }
}
