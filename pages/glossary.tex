...
\newglossaryentry{Fonction softmax}{
    ...
    description={
        ...
        Elle convertit un vecteur de nombre réels en une distribution de probabilités.
        Dans le cas dés réseaux neuronaux elle sert de méthode de classification multiple.
    }    
}
